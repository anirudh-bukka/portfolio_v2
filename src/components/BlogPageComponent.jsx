      ...
      <div className=' flex flex-col rounded-lg mt-4 mb-4 lg:w-[60%] mx-auto p-2    max-sm:m-2'>
        ...
        <div className=" lg:w-[40%] lg:hidden"><img src={Blog1Preview} alt="Preview"/></div>
          <div className=' lg:w-[60%] lg:p-2 flex flex-col justify-between'>
            ...
            <a href='https://medium.com/design-bootcamp/the-design-in-finding-a-problem-and-choosing-the-team-2f2d17255f05' className='border lg:w-fit text-center border-black p-4 hover:bg-black hover:text-white hover:duration-200'>medium.com</a>
          </div>
